---
name: extract
description: Extract learning moments from the current Claude session into the lull-n-learn inbox. Use when the user runs /extract, says "extract cards from this session", "mine this conversation for cards", or is wrapping up a session with learnable content.
---
